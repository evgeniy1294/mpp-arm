  ...
  inline namespace STM32F469_gpio_v1_0
  {
    ...
    constexpr bool IsValidIo()
    {
      ...
      { 
        ...
        case Port::I: return IO::Pin() < 16u;
        case Port::J: return ((IO::Pin() < 6u)||((IO::Pin() > 11u)&&(IO::Pin() < 16u)));
        case Port::K: return ((IO::Pin() > 2u)&&(IO::Pin() < 8u);
    ...
    struct PJ0  
    {
      constexpr inline static auto const Port() noexcept(true) { return Port::J; }
	  constexpr inline static std::uint32_t const Pin()  noexcept(true) { return 0u; }
    ...
    struct PK3  
    {
      constexpr inline static auto const Port() noexcept(true) { return Port::K; }
	  constexpr inline static std::uint32_t const Pin()  noexcept(true) { return 3u; }
      enum { LTDC_B4 = 14ul, }; 
    };
