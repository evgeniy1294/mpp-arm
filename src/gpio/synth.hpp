...
namespace mpp::gpio
{
  ...
  struct OutputInitializer final {
    constexpr inline static auto const __type() noexcept(true) { return Type::Output; } 
    constexpr inline static auto const __driver() noexcept(true) { return Driver::PushPull; }
    constexpr inline static auto const __pull() noexcept(true) { return pull; }
    constexpr inline static auto const __inverted() noexcept(true) {return inverted; }   
  };
  ...
  struct LedInitializer final {
    constexpr inline static auto const __type() noexcept(true) { return Type::Output; } 
    constexpr inline static auto const __driver() noexcept(true) { return Driver::PushPull; }
    constexpr inline static auto const __pull() noexcept(true) { return Pull::Floating; }
    constexpr inline static auto const __inverted() noexcept(true) {return inverted; }   
  };
  ...
  struct InputInitializer final {
    constexpr inline static auto const __type() noexcept(true) { return Type::Input; } 
    constexpr inline static auto const __driver() noexcept(true) { return Driver::PushPull; }
    constexpr inline static auto const __pull() noexcept(true) { return pull; }
    constexpr inline static auto const __inverted() noexcept(true) {return inverted; }   
  };
  ...
  class Gpio /*: public Interface */
  {
    ...
    public:
      ...
      static constexpr auto const type     = InitializerList::__type();
      static constexpr auto const driver   = InitializerList::__driver();
      static constexpr auto const pull     = InitializerList::__pull();
      static constexpr auto const inverted = InitializerList::__inverted();
